    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $user['password'])) {
            ...
            if ($user['role'] == 'admin') {
                ...
                header('Location: /project_root/webPhone.php'); // Chuyển hướng đến trang người dùng
            }
            exit();
        } else {
...
<body>
    <div class="login-container">
        <a href="http://localhost/project_root/webPhone.php"><img src="../../wbingosite.com/resources/images/thoat.jpg" width="23px">Thoát</a>
        ...
        <div class="text-center mt-3">
            <a href="../../wbingosite.com/components/user/forget.php">Quên mật khẩu?</a>
        </div>
    </div>
