    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $user['password'])) {
            ...
            if ($user['role'] == 'admin') {
                ...
                header('Location: http://localhost/project_root/home.php'); // Chuyển hướng đến trang người dùng
            }
            exit();
        } else {
            echo "Sai mật khẩu!";
...
<body>
    ...
    <a href="http://localhost/project_root/home.php"><img src="../../resources/images/thoat.jpg" width="25px"></a>
