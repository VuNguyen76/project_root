...
<body>
  ...
  <a href="http://localhost/project_root/wbingosite.com/WebPhone.php"><img src="../../resources/images/thoat.jpg" width="25px"></a>
    ...
    <form method="POST" action="register.php">
      ...
      <button name="btn" id="btn" class="register-button" type="submit">Đăng ký </button>
    </form>
    <div class="links">
