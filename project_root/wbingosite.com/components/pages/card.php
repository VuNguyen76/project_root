          ...
          if (isset($_SESSION['cart']) && count($_SESSION['cart']) > 0) {
            ...
            if ($productResult->num_rows > 0) {
              while ($product = $productResult->fetch_assoc()) {
                ...
                $productLink = 'http://localhost/project_root/wbingosite.com/components/pages/ProductDetails.php?id=' . htmlspecialchars($product['id']);
              ...
              echo "<a href='http://localhost/project_root/wbingosite.com/components/pages/ProductDetails.php?id=". htmlspecialchars($product['id']) ."</a>";
            }
          } else {
