                ...
                <div class="list">
                    ...
                    <a class="list-specs">
                        ...
                        <button type="submit" id="btngiohang" data-product-id="<?php echo $kqsp['id']; ?>"> Thêm Giỏ
                            Hàng</button>
                        <a href="wbingosite.com/components/acsion/cart_count.php"><button  type="submit"id="btnmua" data-product-id="<?php echo $kqsp['id']; ?>" >Mua hàng</button></a>
                    </div>
                </div>
            <?php endwhile; ?>
        <?php else: ?>
...
<script>
   document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelectorAll("#btngiohang,#btnmua").forEach(function (cartButton) {
        cartButton.addEventListener("click", function () {
            const productId = this.getAttribute("data-product-id");
        if (!productId) {
            console.error("Thông tin sản phẩm không hợp lệ.");
            alert("Có lỗi xảy ra: Thông tin sản phẩm không hợp lệ.");
            return;
        }
